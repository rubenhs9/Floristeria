...
public class panelVentas extends JPanel{
    ...
    public panelVentas(JPanel panelPrincipal, JPanel panelOpciones,   FloristeriaApp floristeriaApp,Color colorPrimario) {
...
//        backgroundImage = imagen.getImage();
    ...
    private void botonVolverAtras(){
        ...
        volverAtras.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                panelPrincipal.remove(panelVentas.this);
        ...
        labelInfo.setText("ESCRIBE EL NOMBRE DEL PRODUCTO QUE QUIERES VENDER                   ");
    ...
    private void mostrarDetallesProducto(String productoSeleccionado) {
        ...
        if (producto == null) {
            ...
            JLabel stockLabel = new JLabel("Selecciona la cantidad a vender: ");
            ...
            JLabel actualizarButton = new JLabel("VENDER CANTIDAD");
            ...
            actualizarButton.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    try {
                        floristeriaApp.venderProducto(producto.getNombre(), nuevoStock);
                    } catch (Exception ex) {
